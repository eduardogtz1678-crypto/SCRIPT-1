...
CamShake:Stop()
    ...
    local i = "Blox Fruits Ultimate | @Dudumodss"
...
local Window = OrionLib:MakeWindow({Name = "Blox Fruits Ultimate | @Dudumodss", HidePremium = false, IntroText = "By @Dudumodss", IntroIcon = "rbxassetid://119980140458596", SaveConfig = true, ConfigFolder = "Blox Fruits Ultimate", Keybind = Enum.KeyCode.RightControl})

OrionLib:MakeNotification({
	Name = "Blox Fruits Ultimate | @Dudumodss",
...
OrionLib:MakeNotification({
	Name = "Blox Fruits Ultimate | @Dudumodss",
	Content = "Blox Fruits Ultimate | @Dudumodss",
	Image = "rbxassetid://119980140458596",
	Time = 25
})
...
W:AddLabel("[+] Blox Fruits Ultimate | @Dudumodss is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Blox Fruits Ultimate | @Dudumodss(Noitification)",
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    OrionLib:MakeNotification({
                        Name = "Blox Fruits Ultimate | @Dudumodss BOT",
